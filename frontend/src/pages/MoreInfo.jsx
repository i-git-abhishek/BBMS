  ...
  return (
    <>
      ...
      <div className="container my-5">
        <h2 className="text-danger">{bloodGroup} Blood Group</h2>
        <h5 className="text-secondary mb-4">
          Total Available: {Math.floor(total)} mL
        </h5>
        {data.length === 0 ? (
          <p className="text-muted">
            No hospitals currently have this blood group.
          </p>
        ) : (
          <div className="row">
            {data.map((h, idx) => (
                ...
                <div className="card shadow-sm">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      <strong>Quantity:</strong> {Math.floor(h.quantity)}
                      <br />
                      <strong>Address:</strong> {h.address}, {h.city}, {h.state}
                      , {h.zipcode}
                      <br />
                      <strong>Contact:</strong> {h.contact}
                      <br />
